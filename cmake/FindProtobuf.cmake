...
function(PROTOBUF_GENERATE_CPP SRCS HDRS PROTO)
  ...
  get_filename_component(ORIGINAL_DIR ${PROTO} DIRECTORY)
  get_filename_component(DESTINATION_DIR ${ORIGINAL_DIR} NAME_WE)

  list(APPEND ${SRCS} "${CMAKE_CURRENT_BINARY_DIR}/${DESTINATION_DIR}/${FIL_WE}.pb.cc")
  list(APPEND ${HDRS} "${CMAKE_CURRENT_BINARY_DIR}/${DESTINATION_DIR}/${FIL_WE}.pb.h")

  make_directory(${CMAKE_CURRENT_BINARY_DIR}/${DESTINATION_DIR})

  add_custom_command(
      OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/${DESTINATION_DIR}/${FIL_WE}.pb.cc"
             "${CMAKE_CURRENT_BINARY_DIR}/${DESTINATION_DIR}/${FIL_WE}.pb.h"
